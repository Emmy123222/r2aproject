...
const Coordinator = () => {
  ...
  const message = `
    ...
    each means a lot to God who made us all. Divers people represent a variety of 
  ...
  return (
    <div className=" p-4 space-y-4 ">
      ...
      {/* List of Items */}
      <p className="text-[20px] text-gray-700 font-serif leading-relaxed space-y-4">
      ...
      <div className="mt-6 text-[20px] text-gray-700 font-serif">
      ...
      {/* Contact Info */}
      <div className="text-[18px] text-gray-600 font-serif space-y-2">
